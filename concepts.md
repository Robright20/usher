...
They rating and comments available in the corrected's feedbacks section may reveal
bad corrections also.
**The rating**
After every evaluation, student(the team leader) can rate the evaluation based on
the interest, the behavior, the punctuality, rigor. And the rating will be from 0 to 4
for each of those.
We will therefore consider as bad evalution all the one with a corrected's feedback
